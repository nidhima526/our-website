...
const Home = () => {
  ...
  return (
    <CorporateLayout>
      ...
      <section ref={heroRef} className="relative min-h-screen w-full overflow-hidden bg-[#050b14] flex flex-col justify-center items-center">
        {/* Dynamic Abstract Background */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-600/20 rounded-full blur-[120px] mix-blend-screen animate-pulse pointer-events-none"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-orange-600/20 rounded-full blur-[120px] mix-blend-screen animate-pulse delay-1000 pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-32">
            ...
            <div ref={el => sectionRefs.current[1] = el} className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div className="h-[60vh] rounded-3xl overflow-hidden bg-gray-900 border border-white/10 relative group">
                <div className="absolute inset-0 bg-blue-900/40 group-hover:bg-transparent transition-colors duration-1000 z-10"></div>
                <img src="/custom_tech_logo.jpg" alt="Technology" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[2s] ease-out" />
              </div>
              <div>
                <Monitor size={48} className="text-blue-500 mb-8" />
                <h3 className="text-5xl font-black mb-6 tracking-tight">Technology</h3>
                <p className="text-gray-400 text-xl font-light leading-relaxed mb-10">Enterprise software, web & mobile applications, AI integration, ERP systems, and secure cloud infrastructure tailored to your exact operational needs.</p>
            ...
            <div ref={el => sectionRefs.current[2] = el} className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div className="order-2 md:order-1">
                ...
                <p className="text-gray-400 text-xl font-light leading-relaxed mb-10">Expert consultation, documentation, civil, criminal, and corporate legal representation with unwavering precision.</p>
              ...
              <div className="order-1 md:order-2 h-[60vh] rounded-3xl overflow-hidden bg-gray-900 border border-white/10 relative group">
                <div className="absolute inset-0 bg-orange-900/20 group-hover:bg-transparent transition-colors duration-1000 z-10"></div>
                <img src="/legalpage.jpg" alt="Legal" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[2s] ease-out" />
              </div>
            </div>
            ...
            <div ref={el => sectionRefs.current[3] = el} className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div className="h-[60vh] rounded-3xl overflow-hidden bg-gray-900 border border-white/10 relative group">
                ...
                <img src="/digitalmarketing.jpg" alt="Creative" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[2s] ease-out" />
              </div>
              <div>
                <Zap size={48} className="text-yellow-500 mb-8" />
                <h3 className="text-5xl font-black mb-6 tracking-tight">Creative</h3>
                <p className="text-gray-400 text-xl font-light leading-relaxed mb-10">Brand strategy, SEO, Google Ads, UI/UX design, and premium video editing services that make them pause.</p>
      ...
      {/* 3. PREMIUM STATS */}
      <section className="py-40 bg-[#050b14] text-white relative overflow-hidden border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-16 text-center">
            <div ref={el => sectionRefs.current[4] = el}>
              ...
              <div className="text-sm font-bold tracking-[0.3em] uppercase text-gray-500">Clients</div>
            </div>
            <div ref={el => sectionRefs.current[5] = el}>
              ...
              <div className="text-sm font-bold tracking-[0.3em] uppercase text-gray-500">Students</div>
            </div>
            <div ref={el => sectionRefs.current[6] = el}>
              ...
              <div className="text-sm font-bold tracking-[0.3em] uppercase text-gray-500">Projects</div>
            </div>
            <div ref={el => sectionRefs.current[7] = el}>
              ...
              <div className="text-sm font-bold tracking-[0.3em] uppercase text-gray-500">Rating</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* 4. FINAL CTA SECTION */}
      <section ref={el => sectionRefs.current[8] = el} className="py-40 bg-black relative overflow-hidden flex flex-col items-center text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-500 mb-16 max-w-2xl font-light">
          The difference between something that exists and something that matters.
        </p>
        <Link to="/contact" className="group flex items-center gap-4 bg-transparent border-2 border-white text-white font-black px-12 py-6 rounded-full hover:bg-white hover:text-black transition-all duration-500 ease-out text-xl">
          Work With Us
          <ArrowRight size={24} className="group-hover:translate-x-2 transition-transform duration-500" />
        </Link>
      </section>
