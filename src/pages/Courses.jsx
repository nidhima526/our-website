    ...
    <CorporateLayout>
      <div className="w-full min-h-screen bg-[#0a0a0a] relative selection:bg-yellow-600 selection:text-white font-sans overflow-hidden">
        ...
        <div className="relative w-full min-h-[90vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden mb-16 rounded-b-[4rem] shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
          ...
          <div className="relative z-10 max-w-6xl mx-auto pt-32 pb-12 mt-16">
            <motion.div 
              ...
              className="inline-flex items-center justify-center gap-3 mb-6 px-6 py-2.5 rounded-full border border-yellow-500/30 bg-yellow-500/10 backdrop-blur-md shadow-xl text-yellow-500"
            >
            ...
            <motion.h1 
              ...
              className="text-5xl sm:text-6xl md:text-8xl font-light text-white tracking-tight mb-8 leading-[1.1]"
              style={{ fontFamily: 'Georgia, serif', textShadow: '0 4px 30px rgba(0,0,0,0.8), 0 2px 10px rgba(0,0,0,0.5)' }}
              style={{ fontFamily: 'Georgia, serif' }}
            >
              Build Skills. <span className="italic font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-600 via-yellow-400 to-yellow-200">Earn Certifications.</span><br />
              Advance Your Career.
            </motion.h1>
            ...
            >
              <a href="#courses" className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-gradient-to-r from-yellow-700 to-yellow-600 text-white rounded-full hover:from-yellow-600 hover:to-yellow-500 hover:-translate-y-1 transition-all duration-300 uppercase tracking-widest text-sm font-bold shadow-[0_0_30px_rgba(202,138,4,0.3)]">
                <BookOpen size={18} />
                Explore Courses
              </a>
              <a href="/contact" className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-[#111] text-white border border-yellow-600/30 rounded-full hover:bg-yellow-600/10 hover:-translate-y-1 transition-all duration-300 uppercase tracking-widest text-sm font-bold shadow-xl">
                <FileText size={18} />
                Enroll Now
              </a>
            </motion.div>
          ...
          >
            {courseFeatures.map((feature, idx) => (
              <motion.div 
                ...
                className="bg-[#111] p-6 rounded-2xl shadow-xl border border-white/5 hover:border-yellow-500/30 transition-all duration-300 flex flex-col items-center text-center group"
              >
        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-8 pb-32 relative z-10">
          <div className="flex flex-col lg:flex-row gap-8 bg-[#111] rounded-[3rem] border border-white/5 p-4 lg:p-8 shadow-2xl">
            ...
            <div className="w-full lg:w-2/3 bg-[#0a0a0a] rounded-3xl border border-white/5 overflow-hidden flex flex-col relative min-h-[800px]">
            ...
            {learningPaths.map((path, idx) => (
              ...
              >
                <div className="absolute inset-0 z-0 bg-[#0a0a0a]">
                  <img src={path.image} alt={path.title} className="w-full h-full object-cover opacity-20 group-hover:opacity-40 transition-all duration-700 group-hover:scale-110" />
